public class Tester {
    ...
    public static void main(String[] args) {
        ...
        String s3 = "!A+!A+!A+1+!AAAAA+!A+!AA+!A+!A";
        String s4 = "!DD+D!D+D!D+!DD+D!DD";
        ...
        */
        ...
        System.out.println(bdd.calculateReductionRatio());
        System.out.println(Math.pow(2, 21)-1);

        /*
        System.out.println("================== A ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('A', s1));
        System.out.println("================== B ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('B', s1));
        System.out.println("================== C ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('C', s1));
        System.out.println("================== D ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('D', s1));
        System.out.println("================== E ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('E', s1));
        System.out.println("================== F ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('F', s1));
        System.out.println("================== G ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('G', s1));
        System.out.println("================== H ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('H', s1));
        System.out.println("================== I ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('I', s1));
        System.out.println("================== J ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('J', s1));
        System.out.println("================== K ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('K', s1));
        System.out.println("================== L ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('L', s1));
        System.out.println("================== M ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('M', s1));
        System.out.println("================== N ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('N', s1));
        System.out.println("================== O ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('O', s1));
        System.out.println("================== P ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('P', s1));
        System.out.println("================== Q ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('Q', s1));
        System.out.println("================== R ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('R', s1));
        System.out.println("================== S ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('S', s1));
        System.out.println("================== T ==================");
        System.out.println(s1 = bdd.createFalseBranchFunction('T', s1));
         */

        /*
        System.out.println("================== A ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('A', s1));
        System.out.println("================== B ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('B', s1));
        System.out.println("================== C ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('C', s1));
        System.out.println("================== D ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('D', s1));
        System.out.println("================== E ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('E', s1));
        System.out.println("================== F ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('F', s1));
        System.out.println("================== G ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('G', s1));
        System.out.println("================== H ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('H', s1));
        System.out.println("================== I ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('I', s1));
        System.out.println("================== J ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('J', s1));
        System.out.println("================== K ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('K', s1));
        System.out.println("================== L ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('L', s1));
        System.out.println("================== M ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('M', s1));
        System.out.println("================== N ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('N', s1));
        System.out.println("================== O ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('O', s1));
        System.out.println("================== P ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('P', s1));
        System.out.println("================== Q ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('Q', s1));
        System.out.println("================== R ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('R', s1));
        System.out.println("================== S ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('S', s1));
        System.out.println("================== T ==================");
        System.out.println(s1 = bdd.createTrueBranchFunction('T', s1));
        */
